...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      ...
      {isOpen && <div className="p-4 bg-gray-50 border-t border-gray-200 text-sm text-gray-600">{answer}</div>}
    </div>
  )
}
  ...
  return (
    <button
      ...
      className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
        isActive ? 'bg-[#0083a0] text-white shadow-sm' : 'bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900 border border-gray-200'
      }`}
    >
      {children}
    </button>
...
function SettingsManualContent({ activeTab, setActiveTab }: { activeTab: string; setActiveTab: (tab: string) => void }) {
  return (
    <div>
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-4">
          <StepCard number={1} title="スプレッドシートの準備" description="Googleスプレッドシートを開き、以下の情報を確認します" time="2分" />
              ...
              <div>
                ...
                <div className="bg-white p-3 rounded border border-gray-200">
                  <div className="text-sm text-gray-600">
                    スプレッドシート下部のタブ名を確認（例: <code className="bg-gray-100 px-1 rounded">12.TEMPOS</code>）
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="bg-white p-3 rounded border border-gray-200">
                  ...
                  <div className="mt-2 text-xs text-gray-500">
                    ↑ <code className="bg-gray-200 px-1 rounded">#gid=</code> の後の数字が「シートgid」です
                  </div>
          ...
          <StepCard number={2} title="設定画面で情報を入力" description="設定メニューの「スプレッドシート連携」タブで情報を入力します" time="3分" />
          <div className="ml-14 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="space-y-3 text-sm">
              ...
              <div className="bg-blue-50 p-3 rounded border border-blue-200">
                ...
                <div className="text-xs text-blue-700 mt-1">これでスプレッドシートから列名が読み込まれます</div>
              </div>
            </div>
          </div>

          <StepCard number={3} title="カラムマッピングを設定" description="各列をデータベースのフィールドに対応付けます" time="5分" />
          <div className="ml-14 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="space-y-3 text-sm">
              ...
              <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
                ...
                <div className="text-xs text-yellow-800">ヘッダー名が一致する場合は自動でマッピングされます。不一致の場合は手動で選択してください。</div>
              </div>
              <div className="bg-white p-3 rounded border border-gray-200">
                <div className="font-semibold text-gray-900 mb-2">必須項目のマッピング</div>
                <div className="text-xs text-gray-600 space-y-1">
                  <div>
                    • <strong>会社名または氏名</strong>: <code className="bg-gray-100 px-1 rounded">companyName</code> または{' '}
                    <code className="bg-gray-100 px-1 rounded">contactName</code>
                  </div>
                  <div>
                    • <strong>電話番号</strong>: <code className="bg-gray-100 px-1 rounded">phone</code>（必須）
                  </div>
          ...
          <StepCard number={4} title="連携設定を保存" description="設定を保存して、次回から簡単にインポートできるようにします" time="1分" />
          <div className="ml-14 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="space-y-3 text-sm">
              <div className="bg-white p-3 rounded border border-gray-200">
                ...
                <div className="space-y-2 text-xs text-gray-600">
                  <div>
                    • <strong>連携先名</strong>: 識別しやすい名前を入力（例: TEMPOS, OMC）
                  </div>
                  <div>
                    • <strong>リードIDプレフィックス</strong>: リードID生成時に使用（例: TP, OM）
                  </div>
              ...
              <div className="bg-green-50 p-3 rounded border border-green-200">
                ...
                <div className="text-xs text-green-700">次回からは「連携済一覧」タブから選択するだけで、設定済みのスプレッドシートをすぐにインポートできます。</div>
              </div>
            </div>
          </div>

          <StepCard number={5} title="データをインポート" description="マッピング設定を確認して、データをインポートします" time="2分" />
          <div className="ml-14 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="space-y-3 text-sm">
              <div className="bg-white p-3 rounded border border-gray-200">
              ...
              <div className="bg-blue-50 p-3 rounded border border-blue-200">
                ...
                <div className="text-xs text-blue-700 mt-1">インポート結果が表示されます。成功数、失敗数、エラー内容を確認してください。</div>
              </div>
              <div className="bg-white p-3 rounded border border-gray-200">
                <div className="font-semibold text-gray-900 mb-1">重複チェック</div>
                <div className="text-xs text-gray-600">電話番号が既存データと重複している場合、既存レコードが更新されます（新規作成されません）。</div>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-4">
          <StepCard number={1} title="CSVファイルの準備" description="インポート用のCSVファイルを準備します" time="5分" />
          <div className="ml-14 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="space-y-3 text-sm">
              <div className="bg-white p-3 rounded border border-gray-200">
                ...
                <ul className="text-xs text-gray-600 space-y-1 list-disc ml-4">
                  <li>
                    <strong>文字コード</strong>: UTF-8推奨（Excelで保存する場合は「CSV UTF-8（コンマ区切り）」を選択）
                  </li>
                  <li>
                    <strong>1行目</strong>: ヘッダー行（列名）として自動認識されます
                  </li>
                  <li>
                    <strong>区切り文字</strong>: カンマ（,）
                  </li>
                  <li>
                    <strong>改行コード</strong>: CRLF（Windows）またはLF（Mac/Linux）
                  </li>
                </ul>
              </div>
              <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
          ...
          <StepCard number={2} title="CSVファイルを選択" description="設定画面でCSVファイルを選択します" time="10秒" />
          <div className="ml-14 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="space-y-3 text-sm">
              <div className="bg-white p-3 rounded border border-gray-200">
          ...
          <StepCard number={3} title="カラムマッピングを設定" description="CSVの各列をデータベースのフィールドに対応付けます" time="3分" />
          <div className="ml-14 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="space-y-3 text-sm">
              <div className="bg-white p-3 rounded border border-gray-200">
                <div className="font-semibold text-gray-900 mb-2">自動マッピング</div>
                <div className="text-xs text-gray-600">CSVの1行目（ヘッダー行）の列名が、システムのフィールド名と一致する場合は自動でマッピングされます。</div>
              </div>
              <div className="bg-blue-50 p-3 rounded border border-blue-200">
                ...
                <div className="text-xs text-blue-700 space-y-1">
                  ...
                  <div>
                    • <strong>電話番号</strong>: <code className="bg-gray-100 px-1 rounded">phone</code>
                  </div>
                </div>
              </div>
            </div>
          ...
          <StepCard number={4} title="データをインポート" description="マッピング設定を確認して、データをインポートします" time="1分" />
          <div className="ml-14 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="space-y-3 text-sm">
              <div className="bg-white p-3 rounded border border-gray-200">
                <div className="font-semibold text-gray-900 mb-2">インポート前の確認</div>
              ...
              <div className="bg-green-50 p-3 rounded border border-green-200">
                ...
                <div className="text-xs text-green-700 mt-1">インポート結果が表示されます。成功数、失敗数、エラー内容を確認してください。</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <TipCard type="warning" title="インポート時の注意">
        <ul className="space-y-1">
          <li>
            • <strong>必須項目</strong>: 会社名/店舗名、氏名、電話番号
          </li>
...
function SavedSettingsContent() {
  return (
    <div>
      ...
      <div className="mb-6">
        <p className="text-gray-600 mb-6">
          「連携済一覧」タブでは、保存済みのスプレッドシート連携設定を一覧で確認・管理できます。一度設定を保存しておくと、次回から簡単にインポートできます。
        </p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
              ...
              <div className="text-xs text-blue-700 space-y-1">
                <div>
                  • <strong>編集</strong>: 設定を変更して再保存
                </div>
                <div>
                  • <strong>削除</strong>: 連携設定を削除（データは削除されません）
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            <StepCard number={1} title="連携済一覧から選択" description="「連携済一覧」タブで、編集したい設定の「編集」ボタンをクリック" time="5秒" />
            <StepCard number={2} title="設定を変更" description="スプレッドシート連携タブに移動し、設定を変更します" time="2分" />
            <StepCard number={3} title="更新を保存" description="「連携設定を更新」ボタンをクリックして保存" time="5秒" />
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="text-sm text-gray-700 mb-3">「削除」ボタンをクリックすると、連携設定が削除されます。</div>
            <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
              <div className="font-semibold text-yellow-900 mb-1 text-sm">⚠️ 注意</div>
              <div className="text-xs text-yellow-800">
                設定を削除しても、既にインポートされたデータは削除されません。設定を削除した後も、データはシステム内に残ります。
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="text-sm text-gray-700 mb-3">
              「➕ 新しいスプレッドシート連携を追加」ボタンをクリックすると、新しい連携設定を作成できます。
            </div>
            <div className="space-y-2 text-xs text-gray-600">
        ...
        <TipCard type="info" title="連携管理のベストプラクティス">
          <ul className="space-y-1 text-sm">
            <li>
              • <strong>連携先ごとに設定を保存</strong>: TEMPOS、OMCなど、各連携先ごとに設定を保存しておくと便利です
            </li>
            <li>
              • <strong>定期的な設定確認</strong>: スプレッドシートの構造が変更された場合は、設定も更新してください
            </li>
            <li>
              • <strong>設定名は分かりやすく</strong>: 連携先名は識別しやすい名前を付けましょう（例: TEMPOS、OMC、Makuake）
            </li>
            <li>
              • <strong>リードIDプレフィックス</strong>: 各連携先ごとに異なるプレフィックスを設定すると、リードの出所が分かりやすくなります
            </li>
          </ul>
        </TipCard>
      </div>
...
export function UserManualPage({ embedded = false }: { embedded?: boolean } = {}) {
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-gray-600 mb-6">アライアンス先から取り込まれた全てのリード情報を一覧で確認・管理します。</p>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                <div className="bg-gray-50 px-4 py-2 border-b border-gray-200 font-semibold text-gray-900">🔍 リードを検索する</div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                <div className="bg-gray-50 px-4 py-2 border-b border-gray-200 font-semibold text-gray-900">🎯 フィルターで絞り込む</div>
                <div className="p-4">
              ...
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                <div className="bg-gray-50 px-4 py-2 border-b border-gray-200 font-semibold text-gray-900">📋 詳細情報を確認・編集する</div>
                <div className="p-4 space-y-3">
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-gray-600 mb-6">インサイドセールス（IS）のメイン業務画面です。リードへの架電状況を効率的に管理します。</p>
          ...
          <div className="mb-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-xl p-6 border border-gray-200">
              <FlowStep steps={[{ label: 'リード選択', icon: '👆' }, { label: '電話をかける', icon: '📞' }, { label: '結果を記録', icon: '✍️' }, { label: '次回アクション設定', icon: '📅' }]} />
            </div>
          </div>
                ...
                <div className="flex-1">
                  ...
                  <ol className="space-y-2 text-sm text-green-800">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ステータスを<strong>「アポ獲得」</strong>に変更
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-bold">2.</span>
                      <span>
                        <strong>商談予定日時</strong>を入力（日付と時間）
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-bold">3.</span>
                      <span>
                        <strong>商談担当FS</strong>を選択（商談を担当する営業）
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-bold">4.</span>
                      <span>
                        ヒアリング内容を<strong>メモに詳しく記載</strong>（FSへの引き継ぎ情報）
                      </span>
                    </li>
                  </ol>
                </div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-gray-600 mb-6">獲得したアポイントの商談進捗を管理します。主にフィールドセールス（FS）が使用します。</p>
              ...
              <div className="flex items-center justify-between mb-6">
                {[
                  ...
                  <div key={i} className="flex flex-col items-center flex-1">
                    <div className={`w-12 h-12 ${item.color} rounded-full flex items-center justify-center text-white font-bold mb-2`}>{i + 1}</div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-gray-600 mb-6">営業パフォーマンスを可視化し、改善ポイントを発見します。マネージャーだけでなく、個人の振り返りにも活用できます。</p>
                  ...
                  {[
                    ...
                    <tr key={i}>
                      ...
                      <td className="px-4 py-3">
                        <span className="px-2 py-0.5 bg-green-100 text-green-800 rounded text-xs">{item.target}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-gray-600 mb-6">ユーザーからよく寄せられる質問と回答をまとめました。</p>
          ...
          <div className="space-y-3">
            ...
            />
            <FAQItem question="データのエクスポート（出力）はできますか？" answer="現在、標準機能としてのエクスポートは実装されていません。データの出力が必要な場合は、管理者にご相談ください。" />
            <FAQItem
          ...
          <div className="mt-8 p-6 bg-gray-50 rounded-xl border border-gray-200 text-center">
            ...
            <p className="text-sm text-gray-600 mb-4">上記にない質問や、システムの不具合については管理者までお問い合わせください。</p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-gray-600 mb-6">よく使う操作をキーボードで素早く実行できます。</p>
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-4 shrink-0 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div className="ml-auto">
              <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">📖 v1.0 | 最終更新: 2026-01-07</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-64 bg-white border-r border-gray-200 overflow-y-auto shrink-0 py-4">
          <nav className="space-y-1 px-3">
            {manualSections.map((section: ManualSection) => (
              <button
                key={section.id}
              ...
              >
                <span className={activeSection === section.id ? 'text-[#0083a0]' : 'text-gray-400'}>{section.icon}</span>
                <span className="flex-1 text-left">{section.title}</span>
                {section.badge && <span className="px-1.5 py-0.5 text-[10px] font-bold text-white rounded" style={{ backgroundColor: '#0083a0' }}>{section.badge}</span>}
              </button>
            ))}
          </nav>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-4xl mx-auto p-10">
            {activeSection === 'settings' ? (
              <SettingsManualContent activeTab={activeSettingsTab} setActiveTab={setActiveSettingsTab} />
            ) : (
